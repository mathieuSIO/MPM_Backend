...
import { updateOrderShippingSchema, updateOrderStatusSchema } from "../schemas/admin-order.schema.js";
...
adminOrderRouter.patch("/:orderId/shipping", requireAuth, requireAdmin, validateBody(updateOrderShippingSchema), asyncHandler(orderController.updateAdminOrderShipping));
